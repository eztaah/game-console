...
CUchar *font, *font2;
Uchar width, height, letter_spacing, dot_size = 0, frame_memory = 0x88;
Uint tft_x = 240 - 1;



void TFT_Init(void){
TRISDbits.TRISD0 = 0; TRISDbits.TRISD2 = 0; TRISDbits.TRISD1 = 0;
LATDbits.LATD0 = 1; LATDbits.LATD2 = 0; LATDbits.LATD1 = 0;
TFT_Reset();
...
TFT_FillScreen(0b1111111111111111);
}
...
void TFT_Reset(void){
LATDbits.LATD0 = 1;
LATDbits.LATD1 = 0; Delay_ms(50);
LATDbits.LATD1 = 1; Delay_ms(150);
}
...
void TFT_ColumnPage(Uint x1, Uint x2, Uint y1, Uint y2){
LATDbits.LATD0 = 0;
LATDbits.LATD2 = 0; SPI1_Write(0x2A);
LATDbits.LATD2 = 1; SPI1_Write(x1 >> 8); SPI1_Write(x1 & 0xFF); SPI1_Write(x2 >> 8); SPI1_Write(x2 & 0xFF);
LATDbits.LATD2 = 0; SPI1_Write(0x2B);
LATDbits.LATD2 = 1; SPI1_Write(y1 >> 8); SPI1_Write(y1 & 0xFF); SPI1_Write(y2 >> 8); SPI1_Write(y2 & 0xFF);
LATDbits.LATD2 = 0; SPI1_Write(0x2C);
LATDbits.LATD0 = 1;
}
...
switch(frame_memory_)
      {
       case 0x88: tft_x = 240 - 1; break;
       case 0xE8: tft_x = 320 - 1; break;
       case 0x08: tft_x = 240 - 1; break;
      }
...
LATDbits.LATD0 = 0;
LATDbits.LATD2 = 0; SPI1_Write(0x2A);
LATDbits.LATD2 = 1; SPI1_Write(x >> 8); SPI1_Write(x & 0xFF); SPI1_Write(x >> 8); SPI1_Write(x & 0xFF);
LATDbits.LATD2 = 0; SPI1_Write(0x2B);
LATDbits.LATD2 = 1; SPI1_Write(y >> 8); SPI1_Write(y & 0xFF); SPI1_Write(y >> 8); SPI1_Write(y & 0xFF);
LATDbits.LATD2 = 0; SPI1_Write(0x2C);
LATDbits.LATD2 = 1; SPI1_Write(color >> 8); SPI1_Write(color & 0xFF);
LATDbits.LATD0 = 1;
}
...
LATDbits.LATD0 = 0; LATDbits.LATD2 = 1;
while(i)
     {
      SPI1_Write(color >> 8);
...
switch(frame_memory)
      {
       case 0x88: TFT_ColumnPage(0, 240 - 1, 0, 320 - 1); break;
       case 0xE8: TFT_ColumnPage(0, 320 - 1, 0, 240 - 1); break;
      }
LATDbits.LATD0 = 0; LATDbits.LATD2 = 1;
for(i = 0; i < 320; i++)
   {
