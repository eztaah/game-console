...
void main(void)
{
    ...
    while(1) {
        ...
        if (new_top <= 0) {
            ...
            ball_speed.y *= -1;
        } else if (new_bottom >= 320) {
            new_bottom = 320;
            ball_position.y = 320 - ball_size/2;
            ball_speed.y *= -1;
        }
        ...
        if (new_left <= 0) {
            ...
            ball_speed.x *= -1;
        } else if (new_right >= 240) {
            new_right = 240;
            ball_position.x = 240 - ball_size/2;
            ball_speed.x *= -1;
        }
        ...
        if (new_left > old_left) {
            TFT_Box(old_left, old_top, new_left, old_bottom, 0b1111111111111111);
        }

        if (new_right < old_right) {
            TFT_Box(new_right, old_top, old_right, old_bottom, 0b1111111111111111);
        }

        if (new_top > old_top) {
            TFT_Box(old_left, old_top, old_right, new_top, 0b1111111111111111);
        }

        if (new_bottom < old_bottom) {
            TFT_Box(old_left, new_bottom, old_right, old_bottom, 0b1111111111111111);
        }


        TFT_Box(new_left, new_top, new_right, new_bottom, 0b0000000000000000);
    }
}
