...
void main(void)
{
    ...
    while(1){
        ...
        if (ball_position.y + ball_radius >= 320 || ball_position.y - ball_radius <= 0) {
            ball_speed.y *= -1;
        }
        if (ball_position.x + ball_radius >= 240 || ball_position.x - ball_radius <= 0) {
            ball_speed.x *= -1;
        }


        TFT_FillScreen(0b1111111111111111);
        TFT_CircleFill(ball_position.x, ball_position.y, ball_radius, 0b0000000000000000);
    }
}
