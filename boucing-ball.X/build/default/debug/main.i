...
TFT_SetDotSize(1);
TFT_RectangleRound(5, 115, 234, 314, 10, 0b0000000000000000);
TFT_SetFont(Courier_New_Bold_20, 1);
TFT_ConstText("TFT 240x320", 20, 10, 0b0000000000000000, 0b1111111111111111);
TFT_ConstText("Driver ILI9341", 20, 34, 0b0000000000000000, 0b1111111111111111);
TFT_ConstText("Interface: SPI", 20, 58, 0b0000000000000000, 0b1111111111111111);
TFT_ConstText("Version",20, 82, 0b0000000000000000, 0b1111111111111111);
Delay_ms(1000);

TFT_WriteChar('>', 0, 10, 0b0000000000000000, 0b1111111111111111); TFT_ConstText("TFT 240x320", 20, 10, 0b1111111111111111, 0b0000000000000000); Delay_ms(800);
TFT_WriteChar('>', 0, 10, 0b1111111111111111, 0b1111111111111111); TFT_ConstText("TFT 240x320", 20, 10, 0b0000000000000000, 0b1111111111111111);
TFT_WriteChar('>', 0, 34, 0b0000000000000000, 0b1111111111111111); TFT_ConstText("Driver ILI9341", 20, 34, 0b1111111111111111, 0b0000000000000000); Delay_ms(800);
TFT_WriteChar('>', 0, 34, 0b1111111111111111, 0b1111111111111111); TFT_ConstText("Driver ILI9341", 20, 34, 0b0000000000000000, 0b1111111111111111);
TFT_WriteChar('>', 0, 58, 0b0000000000000000, 0b1111111111111111); TFT_ConstText("Interface: SPI", 20, 58, 0b1111111111111111, 0b0000000000000000); Delay_ms(800);
TFT_WriteChar('>', 0, 58, 0b1111111111111111, 0b1111111111111111); TFT_ConstText("Interface: SPI", 20, 58, 0b0000000000000000, 0b1111111111111111);
TFT_WriteChar('>', 0, 82, 0b0000000000000000, 0b1111111111111111); TFT_ConstText("Version", 20, 82, 0b1111111111111111, 0b0000000000000000); Delay_ms(800);

for(i = 31; i > 1; i--)
   {
    sprintf(buffer1, "Version%3d ", i);
    TFT_Text(buffer1, 20, 82, 0b1111111111111111, 0b0000000000000000);
    Delay_ms(200);
   }

TFT_Box(33, 150, 63, 180, 0b1000000000000000);
TFT_Box(103, 150, 133, 180, 0b0000010000000000);
TFT_Box(173, 150, 203, 180, 0b0000000000010000);

TFT_Circle(48, 165, 26, 0b0000000000000000);
TFT_RectangleRound(93, 140, 143, 190, 10, 0b0000000000000000);
TFT_Rectangle(163, 140, 213, 190, 0b0000000000000000);

TFT_Icon(icon1, 20, 220, 64, 64);

TFT_SetDotSize(3);
TFT_RectangleRound(93, 210, 213, 300, 10, 0b0000000000000000);

TFT_SetDotSize(0);
TFT_Line(93, 255, 213, 255, 0b0000000000000000);
TFT_Line(153, 210, 153, 300, 0b0000000000000000);
